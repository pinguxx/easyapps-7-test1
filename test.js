...
document.body.appendChild(wire()`<hyper-table>
    <hyper-column name="id" label="ID" attribute="id"></hyper-column>
    <hyper-column name="name" label="Name" attribute="name"></hyper-column>
    <hyper-column name="date" label="Date" attribute="date" sortable="false" type="date"></hyper-column>
</hyper-table>`);
let table = document.querySelector("hyper-table");
...
tressa.async(done => {
    ...
    return tressa.async(done => {
        ...
        table.addColumn(wire()
            `<hyper-column name="lasthtml" label="Last HTML" attribute="last" />`);
